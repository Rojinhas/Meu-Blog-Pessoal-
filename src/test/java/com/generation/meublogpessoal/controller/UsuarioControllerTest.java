...
import com.generation.meublogpessoal.repository.UsuarioRepository;
import com.generation.meublogpessoal.service.UsuarioService;
...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<>(
				new Usuario(0l, "Paulo Antunes", "paulo_antunes@gmail.com.br", "12345678", "-"));
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService
				.cadastrarUsuario(new Usuario(1L, "Paulo Antunes", "paulo_antunes@email.com.br", "123456789", "-"));
